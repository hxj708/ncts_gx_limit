//package com.haoyu.framework.modules.video.utils;
//
//import cn.hutool.core.collection.CollUtil;
//import cn.hutool.core.img.gif.AnimatedGifEncoder;
//import com.haoyu.framework.modules.video.utils.domain.ImageMetaInfo;
//import com.haoyu.framework.modules.video.utils.domain.VideoMetaInfo;
...
//		Process ffmpeg = null;
//		try {
//			String common = CollUtil.join(commonds, " ");
//			ffmpeg = runtime.exec(common);
//			String result = waitForExcute(ffmpeg);
//
//			// 输出执行的命令信息
//            String cmdStr = Arrays.toString(ffmpegCmds.toArray()).replace(",", "");
//            String resultStr = result != null ? "normal" : "error";
...
//            return "--- 执行FFmpeg程序时读取标准输出或错误流的信息出错 ---";
//        } finally {
//            try {
//				if (null != br2) {
//					br2.close();
...
//	 */
//	public String convertVideo(File fileInput, File fileOutPut) {
//		if (null == fileInput || !fileInput.exists()) {
//			return "源视频文件不存在，请检查源视频路径";
//		}
//		if (null == fileOutPut) {
//			return "转换后的视频路径为空，请检查转换后的视频存放路径是否正确";
//        }
//
//        String format = getFormat(fileInput);
//        if (!isLegalFormat(format, VIDEO_TYPE)) {
//        	return "无法解析的视频格式：" + format;
//        }
//        List<String> commond = new ArrayList<String>();
//		commond.add(FFMPEG_PATH); // 设置ffmpeg程序所在路径
//        commond.add("-i");
...
//		if (null == info) {
//			log.error("--- 未获取到源视频信息，视频帧抽取操作失败 --- 源视频： " + videoFile);
//			return;
//		}
...
//        if (null == videoInfo) {
//            log.error("--- 解析出的视频信息为空，无法从中获取比特率 ---");
//            return -1;
//        }
