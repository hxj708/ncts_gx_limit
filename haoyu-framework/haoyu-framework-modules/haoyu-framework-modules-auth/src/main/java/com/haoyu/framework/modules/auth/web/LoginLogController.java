 ...
 * @since 2020-07-20
 */
@RestController("loginLogController")
@RequestMapping("/api/v1/auth/loginLog")
public class LoginLogController extends BaseController {
    ...
    */
    ...
    public R page() {
    return R.success().setData(loginLogService.pageByMap(super.getPage(true), super.getParam()));
    }
    ...
    */
    ...
    public R list() {
    return R.success().setData(loginLogService.listByMap(super.getPage(false),super.getParam()));
    }
    ...
    */
    ...
    return R.success().setData(loginLogService.getById(id));
    }
    
    @PostMapping
    @ApiOperation(value = "创建对象记录", notes = "创建对象记录", produces = "application/json")
        public R create(@RequestBody LoginLog entity) {
        return loginLogService.create(entity);
    }
    
    @PutMapping(value = "{id}")
    @ApiOperation(value = "更新对象记录", notes = "更新对象记录", produces = "application/json")
        public R update(@RequestBody LoginLog entity) {
        return loginLogService.update(entity);
    }
    ...
    public R updateBatch(AuthVO vo) {
        return loginLogService.update(vo.getLoginLog(), super.getParam());
    }
    ...
    */
    ...
    public R deleteLogic(@PathVariable String id) {
        return loginLogService.deleteLogic(id);
    }
}
