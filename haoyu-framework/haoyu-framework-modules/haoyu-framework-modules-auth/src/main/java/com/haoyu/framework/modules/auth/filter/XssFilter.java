 ...
 */
package com.haoyu.framework.modules.auth.filter;
...
public class XssFilter implements Filter {
    ...
    private String[][] xsses = {{}};

    public XssFilter(Map<String, String> params) {
        this.initMap(params);
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        // 获取不进行url过滤的接口
        List<String> unXssFilterUrl = authConfig.getIgnores().getXss();
